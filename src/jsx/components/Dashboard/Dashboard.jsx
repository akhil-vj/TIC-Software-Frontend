...
/* 4-item legend: Total, Confirmed, Cancelled, Active Agents */
const CHART_LEGS = [
  { color: "#6366f1", label: "Total",     value: "3,982", seriesName: null        },
  { color: "#1EA7C5", label: "Confirmed", value: "802",   seriesName: "Confirmed" },
  { color: "#FF5166", label: "Cancelled", value: "127",   seriesName: "Cancelled" },
  { color: "#9568FF", label: "Pending",   value: "322",   seriesName: "Pending"   },
];

const SRC_DATA = [
  { color: "#1EA7C5", label: "Primary",   val: "1,122" },
  { color: "#2BC844", label: "Referrals", val: "1,912" },
  { color: "#FF9432", label: "Promotion", val: "768"   },
  { color: "#9568FF", label: "Socials",   val: "5,660" },
];
...
class PerfChart extends React.Component {
  constructor(props) {
    ...
    this.state = {
      series: [
        { name: "Confirmed", data: [46, 48, 56, 65, 57, 67, 100] },
        { name: "Cancelled",  data: [40, 45, 47, 48, 46, 52, 80]  },
        { name: "Pending",    data: [40, 35, 40, 45, 45, 44, 40]  },
      ],
      options: {
        chart: {
          id: "perfChart",
...
/* ─────────────────────────────────────────────────────────────────────────────
   DONUT CHART
───────────────────────────────────────────────────────────────────────────── */
class SrcChart extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      series: [1122, 1912, 768, 5660],
      options: {
        chart: {
          type: "donut",
          height: 240,
        ...
        colors: ["#1EA7C5", "#2BC844", "#FF9432", "#9568FF"],
        legend: { show: false },
        tooltip: {
